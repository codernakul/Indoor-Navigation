...
class total_move(Pose):
       ...
       def controller(self):
           ...
           self.pose_subscriber = rospy.Subscriber('/turtle1/pose', Pose, callback=self.current_pose)
       ...
       def linear_vel(self, target_pose):
           return  self.distance(target_pose)
       ...
       def angular_vel(self, target_pose):
           return (self.turning_angle(target_pose) - self.pose.theta)
